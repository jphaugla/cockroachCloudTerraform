...
ssh_private_key_list = [
    "~/.ssh/jph-cockroach-stage-us-east-1.pem",
    "~/.ssh/jph-cockroach-stage-us-west-2.pem",
    "~/.ssh/jph-cockroach-stage-us-east-2.pem"
]
aws_instance_keys = [
    "jph-cockroach-stage-us-east-1",
    "jph-cockroach-stage-us-west-2",
    "jph-cockroach-stage-us-east-2"
]
vpc_cidr_list = [
    "192.168.3.0/24",
    "192.168.4.0/24",
